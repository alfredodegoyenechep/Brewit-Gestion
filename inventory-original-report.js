...
function originalReportData(state,location,selection,from,to,{waste=false}={}) {
  ...
  if(!waste&&!products.length)throw Error('No hay productos con ambos saldos conocidos en esta bodega y período. Actualiza las tomas de inventario o selecciona otras fechas.');
